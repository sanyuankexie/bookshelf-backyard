...
| 参数名称  | 类型 | 说明                                                         |
| --------- | ---- | ------------------------------------------------------------ |
| errorcode | int  | 0表示注册成功，1表示用户已存在，2表示用户不是合法成员，3表示昵称已存在，4表示未知错误 |
...
| 参数名称  | 类型 | 说明                                                         |
| --------- | ---- | ------------------------------------------------------------ |
| errorcode | int  | 是否产生了错误。0表示没有错误，1表示该书不存在，2表示书本已借出，3表示用户不存在，4表示未知错误 |
...
| 参数名称  | 类型 | 说明                                                         |
| --------- | ---- | ------------------------------------------------------------ |
| errorcode | int  | 是否产生了错误。0表示没有错误，1表示该书不存在，2表示你没有借过这本书，3表示未知错误 |
